...
const Associations = () => {
  return (
    <section id="associations" style={ { minHeight: "280px" } } className="py-10 px-10 md:py-20">
      <h2 className="text-4xl font-bold mb-1">Associations</h2>
      <h3 className="text-xl font-bold mb-6">List of projects that need our support</h3>

      <div className="carousel carousel-end space-x-20 max-w-full rounded-box">
        <div className="carousel-item">
          <div className="card w-96 bg-base-100 shadow-xl">
            ...
            <div className="card-body">
              <h2 className="card-title">Projeto Rios</h2>
        ...
        <div className="carousel-item">
          <div className="card w-96 bg-base-100 shadow-xl">
            ...
            <div className="card-body">
              <h2 className="card-title">PATAV</h2>
        ...
        <div className="carousel-item">
          <div className="card w-96 bg-base-100 shadow-xl">
            ...
            <div className="card-body">
              <h2 className="card-title">Federação Nacional dos Baldios</h2>
